#mkdir -p audio
#mkdir -p lab
lab_dir=/rmt/work/speech_activity_detection/lab/transcr_beam/dev1
...
do 
    ...
    ln -sf $i $new_audio_file_name;
 #  # ln -s $lab_dir/${mic_id}/${mic_id}`echo $sim_id | sed s/sim//`.lab $new_lab_file_name; 
    ln -sf $lab_dir/dev1_${sim_id}_${room_id}.lab $new_lab_file_name;
    echo $new_audio_file_name $new_lab_file_name >> $training_script;
done;

lab_dir=/rmt/work/speech_activity_detection/lab/transcr_beam/test1
...
do 
    ...
    ln -sf $i $new_audio_file_name;
   # ln -s $lab_dir/${mic_id}/${mic_id}`echo $sim_id | sed s/sim//`.lab $new_lab_file_name;
    ln -sf $lab_dir/test1_${sim_id}_${room_id}.lab $new_lab_file_name; 
