...
def convert_ldc_annotations_to_lab(in_annotations_list=None, annotations_dir=None, lab_dir=None, label_map=None):
    ...
    if label_map != None and os.path.exists(label_map):
...
if __name__ == '__main__':
    ...
    defaults = {
                "root_dir" : None,
                "working_dir" : "/home/work/speech_activity_detection/experiments/PLP_0_accum",
                "train_script" : "/home/work/speech_activity_detection/lists/training_files.list",
    ...
    train_ldc_annotations_list = os.path.join(working_dir,'ldc_train_annotations.list')
    test_ldc_annotations_list = os.path.join(working_dir,'ldc_test_annotations.list')
    ...
    lists.create_lists_from_scp(scp=training_scp, 
                                list_of_lists=(training_audio_list, train_ldc_annotations_list))
    lists.create_lists_from_scp(scp=testing_scp, 
                                list_of_lists=(testing_audio_list, test_ldc_annotations_list))
    ...
    convert_ldc_annotations_to_lab(in_annotations_list=train_ldc_annotations_list,
                                   lab_dir=lab_annotations_dir, label_map=label_map) 
    convert_ldc_annotations_to_lab(in_annotations_list=test_ldc_annotations_list, 
                                   lab_dir=lab_annotations_dir, label_map=label_map)
